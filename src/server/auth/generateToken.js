 ...
 * If the function randomBytes fails, use getRandomLetter to generator one new letter for each index
 ...
 */
module.exports = function generateToken(len, url = false) {
  // Get the number of bytes to generate. Each Base64 digit represents exactly 6 bits of data
